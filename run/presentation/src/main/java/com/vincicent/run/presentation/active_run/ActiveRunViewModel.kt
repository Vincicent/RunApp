...
import com.vincicent.core.presentation.ui.asUiText
import com.vincicent.run.domain.LocationDataCalculator
    ...
    fun onAction(action: ActiveRunAction) {
        when (action) {
            ...
            is ActiveRunAction.SubmitPostNotificationPermissionInfo -> {
                state = state.copy(
                    showPostNotificationRationale = action.showPostNotificationRationale
                )
            }
